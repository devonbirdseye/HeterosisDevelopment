...
```{r}
tmt4 <- tmt4[order(tmt4$l2.H1.MP1),]
tmt4.H1.MP1.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.H1.MP1")]
tmt4.H1.MP1.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.H1.MP1")]

tmt4 <- tmt4[order(tmt4$l2.H2.MP2),]
tmt4.H2.MP2.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.H2.MP2")]
tmt4.H2.MP2.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.H2.MP2")]

tmt4 <- tmt4[order(tmt4$l2.H3.MP3),]
tmt4.H3.MP3.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.H3.MP3")]
tmt4.H3.MP3.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.H3.MP3")]

tmt4 <- tmt4[order(tmt4$l2.H4.MP4),]
tmt4.H4.MP4.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.H4.MP4")]
tmt4.H4.MP4.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.H4.MP4")]

tmt4 <- tmt4[order(tmt4$l2.A1.B1),]
tmt4.A1.B1.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.A1.B1")]
tmt4.A1.B1.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.A1.B1")]

tmt4 <- tmt4[order(tmt4$l2.A2.B2),]
tmt4.A2.B2.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.A2.B2")]
tmt4.A2.B2.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.A2.B2")]

tmt4 <- tmt4[order(tmt4$l2.A3.B3),]
tmt4.A3.B3.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.A3.B3")]
tmt4.A3.B3.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.A3.B3")]

tmt4 <- tmt4[order(tmt4$l2.A4.B4),]
tmt4.A4.B4.up <- tmt4[(nrow(tmt4)-100:nrow(tmt4)),c("Entrez", "Gene","Accession","Protein","l2.A4.B4")]
tmt4.A4.B4.down <- tmt4[1:100, c("Entrez", "Gene","Accession","Protein","l2.A4.B4")]
```
```{r}
