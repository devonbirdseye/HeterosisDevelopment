...
organelleEntrez <- tmt[grep("Zema|Zeam", tmt$Gene),]
...
organelleEntrez$Entrez[organelleEntrez$Gene=="ZeamMp157.1"] <- "4056008"
organelleEntrez$Entrez[organelleEntrez$Gene=="ZeamMp107.1"] <- "4056003"
